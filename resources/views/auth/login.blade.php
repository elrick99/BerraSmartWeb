...
<html
  ...
  data-assets-path="{{asset('templates/backend/assets/')}}"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('templates/backend/assets/vendor/css/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('templates/backend/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                    {{-- @if(!App\Models\Application::first()) --}}
                  ...
                  {{-- @else
                  <img src="{{config('app.url').'/'.App\Models\Application::first()->logo}}">
                  @endif --}}
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bienvenue ! 👋</h4>
              <p class="mb-4">Veuillez saisir vos informations</p>
              @if(session('status'))
