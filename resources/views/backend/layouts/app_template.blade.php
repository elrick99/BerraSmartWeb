...
<head>
    ...
    <title>@yield('title') | PSN WEB - Pro</title>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('templates/backend/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />

    <link rel="stylesheet" href="{{ asset('templates/backend/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            @include('backend.layouts.navigation_bar')
            ...
            <div class="layout-page">
                ...
                @include('backend.layouts.header_bar')
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('templates/backend/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('templates/backend/assets/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('templates/backend/assets/js/dashboards-analytics.js') }}"></script>
    <script src="{{ asset('templates/backend/assets/js/ui-modals.js') }}"></script>
