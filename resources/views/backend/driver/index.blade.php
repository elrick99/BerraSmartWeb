...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="row">
                <div class="col-md-2">
                    <h5 class="card-header">Liste Driver ({{ $results->total() }})</h5>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a type="button" class="btn btn-primary"
                               href="{{ route('driver.create') }}"><i class="bx bx-upload me-1"></i>Enregistrement</a>
                        </div>
                        ...
                        @foreach ($results as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge bg-label-warning me-1">Not Approved</span>
                                    @endif

                                </td>
                                <td>
                                    <a class="dropdown-item"
                                       href="{{ route('driver-document.index', ['driver' => $item]) }}"><i
                                            class="bx bx-file me-1"></i> Document</a>
                                    <div class="row">
                                        <div class="col-md-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="{{ route('driver.edit', ['driver' => $item]) }}"><i
